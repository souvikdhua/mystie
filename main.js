document.addEventListener('DOMContentLoaded', () => {
    ...
    const loadUnsplashGallery = async () => {
        ...
        // CORRECTED: The variables are now correctly inserted into the API URL.
        const apiUrl = `http://googleusercontent.com/unsplash.com/2`;
        ...
        try {
            ...
            galleryContainer.innerHTML = `<p class="text-center text-red-400 mx-auto">Could not load images. Please check your API key and network connection.</p>`;
        }
    };
